...
import './NavbarSliderSampling.css';
import Aos from "aos";
                    ...
                    <div>
                        <div className="container-fluid  background">
                            <div className="row">
                                ...
                                >
                                    <h1 className="mainHeadingHero mainHeadingHeroresponsive" >
                                        Get Instant <br />
...
export default NavbarSliderSampling